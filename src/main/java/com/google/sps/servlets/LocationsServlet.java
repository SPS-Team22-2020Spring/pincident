...
public class LocationsServlet extends HttpServlet {
    ...
    public ResultSet returnAllLocationsWhere(HttpServletRequest request, String incidents) throws SQLException, ServletException {
    ...
    public ResultSet returnAllLocations(HttpServletRequest request) throws SQLException, ServletException {
        DataSource pool = (DataSource) request.getServletContext().getAttribute("my-pool");
        try (Connection conn = pool.getConnection()) {
    ...
    public List<Locationob> rstolocobj(ResultSet rs){
        ...
        try {
            while (rs.next()) {
                ...
                Locationob loc = new Locationob(LocationID, GmapsID, Latitude, Longitude, Visualidentifier, Image,
                        Incidentsmap);
                locs.add(loc);
                System.out.println("LocationID: " + LocationID + " GmapsID " + GmapsID + " Latitude: " + Latitude
                        + " Longitude: " + Longitude + " Visualidentifier: " + Visualidentifier + " Image: " + Image
                        + " " + Incidentsmap);
            }
        }catch(Exception e){ 
                System.out.println(e);
